...
Tools and Site lists that I use in CTFs because I Keep forgetting the tools :) So here we are. Also, this will be Gitbook in the future.

**All of these tools are Online / Web Tools**

## Steganography

- Personal Best Steganography - [Aperisolve](https://www.aperisolve.com/)
- [Steganography - stegonline](https://stegonline.georgeom.net/upload)
- [Audio Steganography](https://www.offidocs.com/index.php/desktop-online-video-audio-apps/audacity-audio-editor-online)
- [EXIF Data Viewier](https://exifdata.com/)
...
- [File Signature List - Wiki](https://en.wikipedia.org/wiki/List_of_file_signatures)
- [Disassembly Online](https://onlinedisassembler.com/)
- [Java Decompiler](http://www.javadecompilers.com/)
- [File Type Identifier](https://www.checkfiletype.com/)

## Chronolocation

- [Chronolocation of Media](https://sector035.nl/articles/chronolocation-of-media) - Blog Post with examples
- [Sun Based Chronolocation Site](https://www.suncalc.org/)
...
- [CTF Online Tools - Github](https://github.com/devploit/CTF_OnlineTools)
- [CTF Tools - 1](https://rumkin.com/tools/)
- [CTF Tools - 2](https://amazingtricks.in/tools/ctf-tools/)
- [CTF Tools - 3](https://www.hucerc.com/recommended-tool-list-for-ctf/)
- [OSINT Tool Map - 1](https://map.malfrats.industries/)
- [OSINT Tool Map - 2](https://inteltechniques.com/tools/index.html)
- [OSINT Tool Map -  3 - Best](https://osintframework.com/)
...
- [Windows Malware Analysis - Any.run](https://any.run/)
